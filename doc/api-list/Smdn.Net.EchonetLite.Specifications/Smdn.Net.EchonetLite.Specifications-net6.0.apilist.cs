...
//   InformationalVersion: 1.0.0+838cdb92e75c031e6e808dbbcd4ec3c946326353
...
//     MasterData/0x00-センサ関連機器/0x1B-ＣＯ２センサ.json (1,008 bytes, Embedded, ContainedInManifestFile)
//     MasterData/0x00-センサ関連機器/0x1C-ガスセンサ.json (1,966 bytes, Embedded, ContainedInManifestFile)
//     MasterData/0x00-センサ関連機器/0x1D-ＶＯＣセンサ.json (1,958 bytes, Embedded, ContainedInManifestFile)
...
//     MasterData/0x06-ＡＶ関連機器/0x01-ディスプレー.json (4,402 bytes, Embedded, ContainedInManifestFile)
//     MasterData/0x06-ＡＶ関連機器/0x02-テレビ.json (3,882 bytes, Embedded, ContainedInManifestFile)
//     MasterData/0x06-ＡＶ関連機器/0x03-オーディオ.json (2,203 bytes, Embedded, ContainedInManifestFile)
//     MasterData/0x06-ＡＶ関連機器/0x04-ネットワークカメラ.json (2,252 bytes, Embedded, ContainedInManifestFile)
...
namespace EchoDotNetLite.Specifications {
  ...
  public static class 機器 {
    public static class センサ関連機器 {
      ...
      public static IEchonetObject ＣＯ２センサ { get; }
      public static IEchonetObject ＶＯＣセンサ { get; }
    }
